    ...
    def coleta_precos(self, ipr_gasstation:Posto, ipr_distrito:Posto, ipr_itirapua:Posto, ipr_ppp:Posto, ipr_pitstop:Posto, maximizado=False):
        ...
        while tentativa <= max_tentativas:
            try:
                ...
                print(f"{prefixo} - Coleta de preços do Gás Station realizada com sucesso")
                ...
                print(f"{prefixo} - Coleta de preços do Distrito realizada com sucesso")
                ...
                print(f"{prefixo} - Coleta de preços de Itirapuã realizada com sucesso")
                ...
                print(f"{prefixo} - Coleta de preços do PPP realizada com sucesso")
                ...
                print(f"{prefixo} - Coleta de preços do Pit Stop realizada com sucesso")
