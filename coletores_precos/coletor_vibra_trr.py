    ...
    def coleta_precos(self, vbr_trr:Posto, maximizado=False):
        ...
        while tentativa <= max_tentativas:
            try:
                ...
                print(f"{prefixo} - Login realizado com sucesso")
                ...
                self.clica_botao(self.VAR['xpath_button_atualizar'], sleep_time=5)
                print(f"{prefixo} - Navegação para a página de pedidos e preenchimento dos campos de quantidade realizados com sucesso")
                ...
                print(f"{prefixo} - Seleção de prazo realizada com sucesso")
                ...
                print(f"{prefixo} - Coleta de preços FOB realizada com sucesso")
                ...
                self.clica_botao(self.VAR['xpath_button_atualizar'], sleep_time=5)
                self.clica_botao(self.VAR['xpath_button_atualizar'], sleep_time=5)
                print(f"{prefixo} - Alteração de modo realizada com sucesso")
                ...
                print(f"{prefixo} - Coleta de preços CIF realizada com sucesso")
